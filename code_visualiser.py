        ...
        <body data-theme="{self.theme}">
            ...
            <script>
                ...
                function highlight(code) {{
                    ...
                    const keywords = /\b(def|class|import|from|return|if|else|elif|for|while|try|except|with|as|in|and|or|not|lambda|async|await|function|const|let|var|return|switch|case|break)\b/g;
                    const strings = /(["'`])(?:(?=(\\?))\2.)*?\1/g;
                ...
                function updateLineNumbers(count) {{
                    document.getElementById('lineNumbers').textContent = Array.from({{length: count}}, (_, i) => i + 1).join('\\n');
                }}
